...
type UploadLodgesDialogProps = {
  open: boolean
  onOpenChange: (open: boolean) => void
}

export function UploadLodgesDialog({
  open,
  onOpenChange,
}: UploadLodgesDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='sm:max-w-md'>
        <DialogHeader className='text-start'>
          <DialogTitle>Add Lodges</DialogTitle>
          <DialogDescription>
            Upload a CSV file to add lodges.
          </DialogDescription>
        </DialogHeader>
